  ...
  return (
    <div className=" w-full h-auto flex flex-col justify-center items-center gap-6 mb-4" >
        ...
        {categories.map((cat,id) => (
            ...
            }} key={id} className="group relative w-full rounded-xl overflow-hidden shadow hover:shadow-lg cursor-pointer transition">
                <Image width={100} height={100} src={cat.img} alt={cat.name} className="w-full h-44 object-cover" />
                <div className="absolute bottom-0 w-full h-12 bg-secondary flex flex-col justify-center items-center py-2 transition-transform ease-in duration-300 translate-y-12 group-hover:translate-y-0">
